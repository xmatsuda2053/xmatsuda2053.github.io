...
/* harmony import */ var _utils_elm_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _utils_svg_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _utils_id_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
/* harmony import */ var _utils_event_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6);
/* harmony import */ var _contextMenu_context_menu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(12);
/* harmony import */ var _task_item__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(14);
/* harmony import */ var _group_item__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(16);
/* harmony import */ var _style_tree_view_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(18);
...
function TreeView() {
  class TreeView extends HTMLElement {
    ...
    constructor() {
      super();
      (0,_contextMenu_context_menu__WEBPACK_IMPORTED_MODULE_4__.ContextMenu)();
      (0,_task_item__WEBPACK_IMPORTED_MODULE_5__.TaskItem)();
      (0,_group_item__WEBPACK_IMPORTED_MODULE_6__.GroupItem)();
      ...
      // CSSを適用
      this.shadowRoot.adoptedStyleSheets = _utils_elm_utils__WEBPACK_IMPORTED_MODULE_0__.ElmUtils.createStylesheet(_style_tree_view_css__WEBPACK_IMPORTED_MODULE_7__["default"]);
    ...
    #readElement(nodes) {
      ...
      nodes.forEach((node) => {
        ...
        if (_utils_elm_utils__WEBPACK_IMPORTED_MODULE_0__.ElmUtils.tagEq(node, "task-item")) {
          // タスク
          ...
          elements.push(item);
        } else if (_utils_elm_utils__WEBPACK_IMPORTED_MODULE_0__.ElmUtils.tagEq(node, "group-item")) {
          // グループ
          item.id = node.id || null;
          item.name = node.name || null;
    ...
    #attachAddNewTaskListener() {
      this.shadowRoot.addEventListener("clickAddNewTask", (e) => {
        ...
        this.dispatchEvent(
          _utils_event_utils__WEBPACK_IMPORTED_MODULE_3__.EventUtils.createEvent("addTaskItem", { id: item.id })
        );
      });
    }
    ...
    #attachAddNewGroupListener() {
      this.shadowRoot.addEventListener("clickAddNewGroup", (e) => {
        ...
        this.dispatchEvent(
          _utils_event_utils__WEBPACK_IMPORTED_MODULE_3__.EventUtils.createEvent("addGroupItem", { id: item.id })
        );
      });
    }
     ...
     */
    #createTaskItem(data = {}) {
      const item = _utils_elm_utils__WEBPACK_IMPORTED_MODULE_0__.ElmUtils.createElm("task-item");
      item.init(data);
    ...
    #createGroupItem(data = {}) {
      const item = _utils_elm_utils__WEBPACK_IMPORTED_MODULE_0__.ElmUtils.createElm("group-item");
      item.init(data);
      item.setContextMenu(this.menu);
    ...
    #deleteItem(target) {
      ...
      const typeName = _utils_elm_utils__WEBPACK_IMPORTED_MODULE_0__.ElmUtils.tagEq(target, "task-item")
        ? "タスク"
        : "グループ";
...
/* harmony import */ var _style_context_menu_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(13);
...
/* harmony import */ var _utils_id_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
/* harmony import */ var _utils_event_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6);
/* harmony import */ var _style_task_item_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(15);
...
function TaskItem() {
  class TaskItem extends HTMLElement {
    ...
    constructor() {
      ...
      // CSSを適用
      this.shadowRoot.adoptedStyleSheets = _utils_elm_utils__WEBPACK_IMPORTED_MODULE_0__.ElmUtils.createStylesheet(_style_task_item_css__WEBPACK_IMPORTED_MODULE_4__["default"]);

      // 空の要素を作成
      this.root = _utils_elm_utils__WEBPACK_IMPORTED_MODULE_0__.ElmUtils.createElm("div", "root", ["task-item"]);
...
/* harmony import */ var _utils_id_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
/* harmony import */ var _utils_event_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6);
/* harmony import */ var _style_group_item_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(17);
...
function GroupItem() {
  class GroupItem extends HTMLElement {
    ...
    constructor() {
      ...
      // CSSを適用
      this.shadowRoot.adoptedStyleSheets = _utils_elm_utils__WEBPACK_IMPORTED_MODULE_0__.ElmUtils.createStylesheet(_style_group_item_css__WEBPACK_IMPORTED_MODULE_4__["default"]);

      // 空の要素を作成
      this.summary = _utils_elm_utils__WEBPACK_IMPORTED_MODULE_0__.ElmUtils.createElm("summary");
      this.items = _utils_elm_utils__WEBPACK_IMPORTED_MODULE_0__.ElmUtils.createElm("div", "group-items");
      this.root = _utils_elm_utils__WEBPACK_IMPORTED_MODULE_0__.ElmUtils.createElm("details");
